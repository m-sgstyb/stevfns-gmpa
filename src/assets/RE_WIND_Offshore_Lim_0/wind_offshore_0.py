...
class RE_WIND_Offshore_Lim_0_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_0"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_0_Stock"
    tech_node_type = "WIND_Off_0_Tech_Potential"
