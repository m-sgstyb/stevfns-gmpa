...
class RE_WIND_Onshore_BAU_7_Asset(Asset_STEVFNs):
    """
    Onshore Wind asset with time-dependence, 
    stock-node-based operating capacity tracking.
    """

    asset_name = "RE_WIND_Onshore_BAU_7"
    target_node_type = "EL"

    # Node types used for the stock chain and the technical-potential cap
    stock_node_type = "WIND_On_BAU7_Stock"
    tech_node_type = "WIND_On_BAU7_Tech_Potential"
