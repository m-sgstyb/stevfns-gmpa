...
class RE_PV_Openfield_BAU_Asset(Asset_STEVFNs):
    """
    Openfield PV asset with time-dependence, 
    stock-node-based operating capacity tracking.
    """

    asset_name = "RE_PV_Openfield_BAU"
    target_node_type = "EL"

    # Node types used for the stock chain and the technical-potential cap
    stock_node_type = "PV_Open_BAU_Stock"
    tech_node_type = "PV_Open_BAU_Tech_Potential"
