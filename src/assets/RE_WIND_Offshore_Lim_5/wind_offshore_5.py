...
class RE_WIND_Offshore_Lim_5_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_5"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_5_Stock"
    tech_node_type = "WIND_Off_5_Tech_Potential"
