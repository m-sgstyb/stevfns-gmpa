...
class RE_WIND_Offshore_Lim_3_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_3"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_3_Stock"
    tech_node_type = "WIND_Off_3_Tech_Potential"
