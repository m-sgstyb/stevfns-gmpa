...
class RE_WIND_Offshore_Lim_4_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_4"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_4_Stock"
    tech_node_type = "WIND_Off_4_Tech_Potential"
