...
class RE_WIND_Offshore_Lim_6_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_6"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_6_Stock"
    tech_node_type = "WIND_Off_6_Tech_Potential"
