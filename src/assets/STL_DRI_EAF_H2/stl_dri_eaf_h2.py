...
class STL_DRI_EAF_H2_Asset(Stock_Asset_STEVFNs):
    """
    Time-dependent Steel Production through DRI-EAF NG route
    """
    asset_name = "STL_DRI_EAF_H2"
    source_node_type = "NULL"
    h2_node_type = "H2" # from H2 produced in electrolyser in network
    target_node_type = "STL"     # Steel demand node
    target_node_type_2 = "CO2_Budget"
    target_node_type_3 = "STL_DRI_EAF_H2_Production_Capacity"
    el_node_type = "EL"
    stock_node_type = "STL_DRI_EAF_H2_Production_Stock"
    ...
    @staticmethod
    def hydrogen_fun(flows, params):
        """
        Hydrogen required per Mtn of steel produced
        """
        hydrogen_factor =  params["h2_factor"]
        return hydrogen_factor * flows
    ...
    def __init__(self):
        ...
        self.hydrogen_fun_params = {
            "h2_factor": cp.Parameter(nonneg=True,
                                   name=f"h2_factor_{self.asset_name}")
        }
    ...
    def define_structure(self, asset_structure):
        ...
        self.h2_node_location = asset_structure["Location_1"]
    ...
    def build_edges(self):
        ...
        for edge_number in range(self.number_of_edges):
            ...
            self._build_hydrogen_edge(edge_number)
