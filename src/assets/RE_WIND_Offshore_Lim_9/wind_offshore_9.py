...
class RE_WIND_Offshore_Lim_9_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_9"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_9_Stock"
    tech_node_type = "WIND_Off_9_Tech_Potential"
