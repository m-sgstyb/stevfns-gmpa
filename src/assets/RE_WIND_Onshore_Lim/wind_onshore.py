...
class RE_WIND_Onshore_Lim_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Onshore_Lim"
    target_node_type = "EL"
    stock_node_type = "WIND_On_Lim_Stock"
    tech_node_type = "WIND_On_Lim_Tech_Potential"
