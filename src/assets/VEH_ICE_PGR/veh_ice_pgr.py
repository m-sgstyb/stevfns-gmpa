...
class VEH_ICE_PGR_Asset(Base_Vehicle_Asset_STEVFNs):
    """
    Class of Passenger Internal Combustion Engine Vehicle Fleet
    """
    asset_name = "VEH_ICE_PGR"
    source_node_type = "NULL"
    target_node_type = "PGR" # Passenger demand node
