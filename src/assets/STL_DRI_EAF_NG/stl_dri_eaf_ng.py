...
class STL_DRI_EAF_NG_Asset(Stock_Asset_STEVFNs):
    """
    Time-dependent Steel Production through DRI-EAF NG route
    """
    asset_name = "STL_DRI_EAF_NG"
    source_node_type = "NULL"
    target_node_type = "STL"     # Steel demand node
    target_node_type_2 = "CO2_Budget"
    target_node_type_3 = "STL_DRI_EAF_NG_Production_Capacity"
    el_node_type = "EL"
    stock_node_type = "STL_DRI_EAF_NG_Production_Stock"
