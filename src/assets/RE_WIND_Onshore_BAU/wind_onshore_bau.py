...
class RE_WIND_Onshore_BAU_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Onshore_BAU"
    target_node_type = "EL"
    stock_node_type = "WIND_On_BAU_Stock"
    tech_node_type = "WIND_On_BAU_Tech_Potential"
