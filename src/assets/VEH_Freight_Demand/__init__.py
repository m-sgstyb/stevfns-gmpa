...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 19 15:20:05 2026
...
class VEH_Freight_Demand_Asset(Asset_STEVFNs):
    """
    Class of Freight Demand (road vehicles)
    """
    asset_name = "VEH_Freight_Demand"
    node_type = "FD_VEH"
    source_node_time = 0
    period = 1
    transport_time = 0
    ...
    def define_structure(self, asset_structure):
        ...
        self.node_times = 0
        self.flows = cp.Parameter(nonneg=True, name=f"vehicle_freight_demand_{self.asset_name}")
        return
    ...
    def build_edge(self):
        """
        Method that builds parameter edge for Freight Vehicle Demand Asset
        """
