...
class RE_WIND_Offshore_Lim_1_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_1"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_1_Stock"
    tech_node_type = "WIND_Off_1_Tech_Potential"
