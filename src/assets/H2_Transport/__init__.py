...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 16 12:21:57 2026

@author: Mónica Sagastuy-Breña
Based on NH3_Transport asset author: aniqahsan
"""
...
class H2_Transport_Asset(Asset_STEVFNs):
    ...
    def _update_distance(self):
        """
        Calculates the distance between source and target node coordinates
        from user-input parameters in Location_Parameters.csv
        Distance calculated 'as the bird flies'
        """
