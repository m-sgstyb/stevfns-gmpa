...
class STL_Demand_Asset(Asset_STEVFNs):
    """
    Annual steel demand for the temporal pathways model: 
    Creates an assumed constant hourly, year-length profile
    of steel demand based on annual demand
    ...
    def _load_demand_trajectory(self):
        ...
        annual demand (Mt steel/year) and broadcast it across all years.
        """
