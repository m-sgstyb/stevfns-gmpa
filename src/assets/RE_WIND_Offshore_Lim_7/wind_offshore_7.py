...
class RE_WIND_Offshore_Lim_7_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_7"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_7_Stock"
    tech_node_type = "WIND_Off_7_Tech_Potential"
