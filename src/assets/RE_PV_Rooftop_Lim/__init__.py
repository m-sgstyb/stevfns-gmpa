...
class RE_PV_Rooftop_Lim_Asset(Asset_STEVFNs):
    """
    Rooftop PV asset with time-dependence, 
    stock-node-based operating capacity tracking.
    """

    asset_name = "RE_PV_Rooftop_Lim"
    target_node_type = "EL"

    # Node types used for the stock chain and the technical-potential cap
    stock_node_type = "PV_Roof_Stock"
    tech_node_type = "PV_Roof_Tech_Potential"
