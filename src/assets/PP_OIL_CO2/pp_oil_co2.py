...
class PP_OIL_CO2_Asset(Stock_Asset_STEVFNs):
    """
    Fuel oil fossil generator with an explicit new-build capacity
    ...
    target_node_type_3 = "PP_OIL_CO2_Capacity"
    stock_node_type = "PP_OIL_CO2_Stock"
