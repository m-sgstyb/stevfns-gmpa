...
class PP_NGS_CCGT_CO2_Asset(Stock_Asset_STEVFNs):
    """
    Natrual Gas CCGT fossil generator with an explicit new-build capacity
    stock and a separate hourly dispatch variable, capped per period at available
    ...
    target_node_type_3 = "PP_NGS_CCGT_CO2_Capacity"
    stock_node_type = "PP_NGS_CCGT_CO2_Stock"
