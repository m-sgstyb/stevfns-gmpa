...
class PP_NGS_SCGT_CO2_Asset(Stock_Asset_STEVFNs):
    """
    Natrual Gas SCGT fossil generator with an explicit new-build capacity
    ...
    target_node_type_3 = "PP_NGS_SCGT_CO2_Capacity"
    stock_node_type = "PP_NGS_SCGT_CO2_Stock"
