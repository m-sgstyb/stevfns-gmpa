...
class RE_WIND_Onshore_BAU_3_Asset(Asset_STEVFNs):
    """
    Onshore Wind asset with time-dependence, 
    stock-node-based operating capacity tracking.
    """

    asset_name = "RE_WIND_Onshore_BAU_3"
    target_node_type = "EL"

    # Node types used for the stock chain and the technical-potential cap
    stock_node_type = "WIND_On_BAU3_Stock"
    tech_node_type = "WIND_On_BAU3_Tech_Potential"
