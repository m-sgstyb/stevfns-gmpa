...
class RE_WIND_Offshore_Lim_8_Asset(Stock_Asset_STEVFNs):
    asset_name = "RE_WIND_Offshore_Lim_8"
    target_node_type = "EL"
    stock_node_type = "WIND_Off_8_Stock"
    tech_node_type = "WIND_Off_8_Tech_Potential"
