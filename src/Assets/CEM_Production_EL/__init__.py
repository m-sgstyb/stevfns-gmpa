...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 20 16:02:44 2026
...
class CEM_HTH_EL_Asset(Asset_STEVFNs):
    """
...
class CEM_Production_EL_Asset(Multi_Asset):
    """
    Multi-asset combining Milling (mass -> electricity + process CO2) and
    fully electrified HTH (heat supply).
    Subassets: "Milling" and "HTH".
    """
    asset_name = "CEM_Production_EL"
    assets_class_dictionary = {
        "Milling": CEM_Milling_Asset,
        "HTH": CEM_HTH_EL_Asset
    }
