...
class RE_max_Asset(Asset_STEVFNs):
    ...
    def define_structure(self, asset_structure):
        ...
        self.conversion_fun_params["gen_profile"] = cp.Parameter(
            shape = self.number_of_edges, nonneg=True)
    ...
    def build_edge(self, edge_number):
        ...
        new_edge.conversion_fun_params["conversion_factor"] = self.conversion_fun_params[
            "gen_profile"][edge_number]
        return
    ...
    def _update_parameters(self):
        for parameter_name, parameter in self.cost_fun_params.items():
            if parameter_name == "sizing_vector":
                continue
    ...
    def _load_RE_profile(self):
        ...
        self.conversion_fun_params["gen_profile"].value = new_profile[:self.number_of_edges]
        return
