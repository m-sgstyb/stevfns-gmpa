...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 15 16:08:31 2026
...
class VEH_ICE_Pass_Asset(Asset_STEVFNs):
    """
    Class of Passenger Internal Combustion Engine Vehicle
    """
    asset_name = "VEH_ICE_Pass"
    source_node_type = "NULL"
    target_node_type = "PD_VEH"
    ...
    def conversion_fun(flows, params):
        """
        Converts demand in energy to demand in Mpassenger-km
        """
        conversion_factor = params["conversion_factor"]
    ...
    def __init__(self):
        ...
        self.cost_fun_params = {"sizing_constant": cp.Parameter(nonneg=True,
                          ...
                          "conversion_factor": cp.Parameter(nonneg=True,
                                                            name=f"mpkm_GWh_conversion_factor_{self.asset_name}"),
                          }
    ...
    def define_structure(self, asset_structure):
        ...
        self.flows = cp.Variable(nonneg = True) # Total annual energy from ICE veh. to meet PD_VEH
        return
    
    def build_ice_dem_edge(self):
        """
        Method builds the edge converting energy units to demand to link to 
        the passenger demand node
